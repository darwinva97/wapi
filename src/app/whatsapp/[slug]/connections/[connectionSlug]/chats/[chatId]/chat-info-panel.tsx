...
export function ChatInfoPanel({
  ...
  const handleSaveConfig = () => {
    startTransition(async () => {
      try {
        await updateChatConfigAction(slug, connectionSlug, chatId, {
  ...
  const handleCreateNote = () => {
    ...
    startTransition(async () => {
      try {
        await createNoteAction(slug, connectionSlug, chatId, newNote.trim());
        setNewNote("");
        toast.success("Note created");
      } catch (error) {
        toast.error(error instanceof Error ? error.message : "Error creating note");
      }
    });
  };
  ...
  const handleDeleteNote = (noteId: string) => {
    startTransition(async () => {
      try {
        await deleteNoteAction(slug, connectionSlug, chatId, noteId);
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>{chatInfo.isGroup ? "Group" : "Personal"}</span>
                    </div>
                    <div className="flex justify-between">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Input
                        ...
                        placeholder="Custom name for this chat..."
                        className="mt-1"
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <Label htmlFor="cleanupIncluded" className="flex-1">
                        Include in cleanup (if globally excluded)
                      </Label>
                      <Switch
                        id="cleanupIncluded"
